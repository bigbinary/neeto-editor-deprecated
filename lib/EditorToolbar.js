  ...
  render = () => (
    <trix-toolbar id={this.state.id} style={this.props.toolbarStyles}>
      ...
      <div className="trix-dialogs" data-trix-dialogs>
        ...
        >
          <div className="px-0 d-flex container-fluid align-items-center trix-dialog__link-fields">
            <div className="w-full mr-2 d-flex flex-column flex-grow-1">
              <input
                type="text"
                name="href"
                className="w-full trix-input trix-input--dialog form-control"
        ...
        >
          <div className="mb-0 trix-dialog__link-fields form-group flex-column">
            <div className="px-0 flex flex-row container-fluid align-items-center">
              <div className="mr-3 d-flex flex-column flex-grow-1">
                <input
                  type="url"
                  name="embed"
                  className="w-full trix-input trix-input--dialog form-control"
