...
const DialogButton = ({ style = "primary", ...otherProps }) => (
  <input type="button" className={`nui-btn nui-btn--${style}`} {...otherProps} />
);
...
const EditorToolbar = ({ id = "editorToolbar", insertImage, attachmentRef, toolbarStyles }) => {
  return (
    <trix-toolbar id={id} style={toolbarStyles}>
      <div className="nui-trix-button-row">
        <div
          className="nui-trix-button-group nui-trix-button-group--text-tools"
          data-trix-button-group="text-tools"
        >
          <TrixButton title="Bold" icon="ri-bold" data-trix-key="b" data-trix-attribute="bold" />
          <TrixButton
            title="Italic"
            icon="ri-italic"
            data-trix-key="i"
          ...
          />
          <TrixButton title="Strikethrough" icon="ri-strikethrough" data-trix-attribute="strike" />
          <TrixButton
            title="Link"
            icon="ri-link"
            data-trix-key="k"
          ...
          />
          <TrixButton title="Embed" icon="ri-video-add-line" data-trix-attribute="embed" />
          <TrixButton title="Font Color" icon="ri-font-color" data-trix-attribute="x-color" />
        </div>
        <div
          className="nui-trix-button-group nui-trix-button-group--block-tools"
          data-trix-button-group="block-tools"
        >
          <TrixButton title="Heading" icon="ri-font-size-2" data-trix-attribute="x-heading" />
          <TrixButton title="Blockquote" icon="ri-double-quotes-r" data-trix-attribute="quote" />
          <TrixButton title="Codeblock" icon="ri-code-line" data-trix-attribute="code" />
          <TrixButton
            title="Unordered List"
            icon="ri-list-unordered"
            data-trix-attribute="bullet"
          />
          <TrixButton title="Ordered List" icon="ri-list-ordered" data-trix-attribute="number" />
          <TrixButton
            title="Outdent"
          ...
          />
          <TrixButton title="Note" icon="ri-sticky-note-line" data-trix-attribute="section" />
        </div>
        <div
          className="ml-0 nui-trix-button-group nui-trix-button-group--upload-tools"
          data-trix-button-group="upload-tools"
        >
          <TrixButton title="Add Image" icon="ri-image-add-line" onClick={insertImage} />
          {attachmentRef && (
            <TrixButton
              title="Attach Files"
        ...
        <div
          className="nui-trix-button-group nui-trix-button-group--history-tools"
      ...
      <div className="trix-dialogs" data-trix-dialogs>
        ...
        >
          <div className="flex flex-row items-center justify-start">
            ...
            <div className="flex flex-row items-center justify-end ml-4 space-x-2">
              ...
              <DialogButton style="secondary" value="Unlink" data-trix-method="removeAttribute" />
            </div>
          </div>
        </div>
        ...
        >
          <div className="nui-trix-button-row">
            <button type="button" className="trix-button" data-trix-attribute="heading1">
              H1
            </button>
            <button type="button" className="trix-button" data-trix-attribute="heading2">
              H2
            </button>
            <button type="button" className="trix-button" data-trix-attribute="heading3">
              H3
            </button>
            <button type="button" className="trix-button" data-trix-attribute="heading4">
              H4
            </button>
            <button type="button" className="trix-button" data-trix-attribute="heading5">
              H5
            </button>
            <button type="button" className="trix-button" data-trix-attribute="heading6">
              H6
            </button>
          </div>
        </div>
        ...
        >
          <div className="flex flex-col items-start justify-center">
            <div className="nui-trix-button-group">
              <button
                type="button"
